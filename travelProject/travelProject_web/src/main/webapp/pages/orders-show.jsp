...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/product/main.do"><i
                        class="fa fa-dashboard"></i> 首页</a></li>
                <li><a href="#" disabled="disabled">订单管理</a></li>
        ...
        <section class="content"> <!--订单信息-->
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="产品类型"
                               value="${orders.product.productDesc }" readonly="readonly">
                    </div>
                    ...
                    <div class="col-md-2 title">产品生产地</div>
                    <div class="col-md-4 data">
                    ...
                    <div class="col-md-2 title rowHeight2x">订单评价</div>
                    <div class="col-md-10 data rowHeight2x">
						<textarea class="form-control" rows="3" placeholder="订单评价">
                            ${orders.orderDesc }
                        </textarea>
                    </div>
                </div>
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="用户名"
                               value="${orders.member.name }" readonly="readonly">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="手机号"
                               value="${orders.member.phoneNum}" readonly="readonly">
                    </div>

                    <div class="col-md-2 title">邮箱</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="邮箱"
                               value="${orders.member.email}" readonly="readonly">
                    </div>

<%--                    <div class="col-md-2 title">地址</div>--%>
<%--                    <div class="col-md-4 data">--%>
<%--                        <input type="text" class="form-control" placeholder="地址"--%>
<%--                               value="${orders.userInfo.address}" readonly="readonly">--%>
<%--                    </div>--%>
                </div>
            </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2017 <a
                href="https://bing.biturl.top/?resolution=1920&format=image&index=0&mkt=zh-CN">3D化学元素周期表</a>.
